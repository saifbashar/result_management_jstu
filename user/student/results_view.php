        ...
        <div id="layoutSidenav_content">
            <main class="results-view-main">
                <div class="container-fluid px-4">
                    <h1 class="mt-4 text-center">Welcome
                        <?php echo isset($_SESSION['student_name']) ? htmlspecialchars($_SESSION['student_name']) : ''; ?>
                    </h1>
                    <h3 class="mt-4 text-center">View Your Results</h3>

                    <div class="results-view-card">
                        <div class="card-header">
                            <i class="fas fa-search me-2"></i>
                            Search Semesterwise Result:
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" class="form-control" id="student_id" name="student_id"
                                            value="<?php echo isset($_SESSION['student_id']) ? htmlspecialchars($_SESSION['student_id']) : ''; ?>"
                                            readonly>
                                    </div>
                                    <div class="col-md-6 mb-4">
                    ...
                    <?php if (!empty($success)): ?>
                        <div class="result-container" id="resultContainer">
                            <div class="student-details">
                                ...
                                <p><strong>Session:</strong> <?php echo htmlspecialchars($student_details['session']); ?>
                                </p>
