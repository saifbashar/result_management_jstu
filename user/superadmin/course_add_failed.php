                        ...
                        <div class="card-body">
                            <div class="alert alert-danger results-view-alert" role="alert">
                                ...
                                if (isset($_GET['error'])) {
                                    ...
                                    echo "An unexpected error occurred while adding the course.";
                                }
                                ?>
                            </div>
                            <a href="course_add.php" class="btn btn-secondary">Try Again</a>
                            <a href="course_manage.php" class="btn btn-secondary">Back to Courses Table</a>
                        </div>
                    </div>
                </div>
            </main>
