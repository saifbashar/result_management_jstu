    ...
    <nav class="sb-sidenav accordion" id="sidenavAccordion" style="background: linear-gradient(180deg, #0288d1, #1976d2);">
        <div class="sb-sidenav-menu">
            <div class="nav" style="font-family: 'Playfair Display', serif;">
                ...
                <a class="nav-link" href="./admin_dashboard.php" style="color: #ffffff; font-size: 1.1em; padding: 12px 20px; transition: background 0.3s ease;">
                ...
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts2" aria-expanded="false" aria-controls="collapseLayouts2" style="color: #ffffff; font-size: 1.1em; padding: 12px 20px; transition: background 0.3s ease;">
                    <div class="sb-nav-link-icon"><i class="fas fa-user-tie" style="color: #81d4fa;"></i></div>
                    Coordinators
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down" style="color: #ffffff;"></i></div>
                </a>
                <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav" style="background: rgba(255, 255, 255, 0.1); border-radius: 8px; margin: 0 10px;">
                        <a class="nav-link" href="coordinator_manage.php" style="color: #e0f7fa; font-size: 1em; padding: 10px 30px;">Manage Coordinators</a>
                        <a class="nav-link" href="coordinator_add.php" style="color: #e0f7fa; font-size: 1em; padding: 10px 30px;">Add Coordinator</a>
                    </nav>
                </div>


                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseCourses" aria-expanded="false" aria-controls="collapseCourses" style="color: #ffffff; font-size: 1.1em; padding: 12px 20px; transition: background 0.3s ease;">
                    <div class="sb-nav-link-icon"><i class="fas fa-book" style="color: #81d4fa;"></i></div>
                    Courses
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down" style="color: #ffffff;"></i></div>
                </a>
                <div class="collapse" id="collapseCourses" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav" style="background: rgba(255, 255, 255, 0.1); border-radius: 8px; margin: 0 10px;">
                        <a class="nav-link" href="course_manage.php" style="color: #e0f7fa; font-size: 1em; padding: 10px 30px;">Manage Courses</a>
                        <a class="nav-link" href="course_add.php" style="color: #e0f7fa; font-size: 1em; padding: 10px 30px;">Add Course</a>
                    </nav>
                </div>
            </div>
        </div>
