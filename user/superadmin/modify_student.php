...
if (isset($_GET['id'])) {
    $studentId = $_GET['id'];
    try {
        $sql = "SELECT id, name, session, password, status FROM students WHERE id = :id";
        ...
        die("Error fetching student details: " . htmlspecialchars($e->getMessage()));
    }
} else {
...
<head>
    ...
    <title>Modify Student - RAS Admin</title>
            ...
            <main class="results-view-main">
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Modify Student</li>
                    </ol>
                        ...
                        <div class="card-body results-view-form">
                            <form action="update_student.php" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="session" name="session" value="<?php echo htmlspecialchars($student['session']); ?>" required>
                                </div>

                                <div class="mb-3">
                                    <label for="password" class="form-label">Password:</label>
                                    <input type="text" class="form-control" id="password" name="password" value="<?php echo htmlspecialchars($student['password']); ?>" required>
                                </div>
